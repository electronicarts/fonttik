...
//Core Logger macros
#define LOG_CORE_TRACE(...)					tin::Log::GetCoreLogger()->trace(__VA_ARGS__)
#define LOG_CORE_DEBUG(...)					tin::Log::GetCoreLogger()->debug(__VA_ARGS__)
#define LOG_CORE_INFO(...)					tin::Log::GetCoreLogger()->info(__VA_ARGS__)
#define LOG_CORE_WARNING(...)				tin::Log::GetCoreLogger()->warn(__VA_ARGS__)
#define LOG_CORE_ERROR(...)					tin::Log::GetCoreLogger()->error(__VA_ARGS__)
#define LOG_CORE_CRITICAL(...)				tin::Log::GetCoreLogger()->critical(__VA_ARGS__)
